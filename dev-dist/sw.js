...
define(['./workbox-caf3a6a6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/optimized\/.*\.webp$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/bussola-server\.onrender\.com\/api\//, new workbox.NetworkFirst({
